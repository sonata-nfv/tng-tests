...
${NS_PACKAGE_NAME}  eu.5gtango.tng-smpilot-ns1-k8s-egm.1.8.tgo
${TST_PACKAGE_NAME}  eu.5gtango.industrial-pilot-test-egm-rampup-payload.0.2.tgo
${NS_PACKAGE_SHORT_NAME}  tng-smpilot-ns1-k8s-egm
${TST_PACKAGE_SHORT_NAME}  industrial-pilot-test-egm-rampup-payload
${READY}       READY
${PASSED}      PASSED
