...
${POLICIES_SOURCE_DIR}     tests/SP/test_service_reconfiguration_k8s/policies   # to be modified and added accordingly if policy is not on the same folder as test
