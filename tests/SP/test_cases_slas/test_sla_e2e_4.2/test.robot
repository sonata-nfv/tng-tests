...
Generate the SLA Template
    ${result}=      Create Sla Template         templateName=GOLD   nsd_uuid=${SERVICE_UUID}   expireDate=20/12/2030   guaranteeId=g1   provider_name=UPRC   dflavour_name=    template_initiator=admin   provider_name=admin   service_licence_type=trial   allowed_service_instances=5    service_licence_expiration_date=20/12/2030
