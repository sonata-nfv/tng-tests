...
Generate the SLA Template
    ${result}=      Create Sla Template         templateName=GOLD   nsd_uuid=${SERVICE_UUID}   expireDate=20/12/2030   provider_name=UPRC   service_licence_type=private   allowed_service_instances=5    service_licence_expiration_date=20/12/2030
